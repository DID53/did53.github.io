...
export default function CapstoneDesign() {
  ...
  const data = [
    ...
    },
    {
      ...
      image: "images/CapstoneDesign/product-card_4.png",
      image_detail: "images/CapstoneDesign/product_detail_4.png",
      title: "SOOINK",
  ...
  return (
    <div className="main">
        <img className="intro-img" src="images/CapstoneDesign/intro.png"/>
